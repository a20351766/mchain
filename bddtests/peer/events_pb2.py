...
DESCRIPTOR._options = _descriptor._ParseOptions(descriptor_pb2.FileOptions(), _b('\n\"org.hyperledger.mchain.protos.peerB\rEventsPackageZ)github.com/hyperledger/mchain/protos/peer'))
try:
