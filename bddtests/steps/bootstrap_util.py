...
def getMSPConfig(org, directory):
    ...
    mchainMSPConfig = msp_config_pb2.FabricMSPConfig(admins=adminCerts, root_certs=cacerts, name=org.name, tls_root_certs=tls_root_certs)
    mspConfig = msp_config_pb2.MSPConfig(config=mchainMSPConfig.SerializeToString(), type=0)
    return mspConfig
