...
DESCRIPTOR._options = _descriptor._ParseOptions(descriptor_pb2.FileOptions(), _b('\n%org.hyperledger.mchain.protos.ordererZ,github.com/hyperledger/mchain/protos/orderer'))
try:
