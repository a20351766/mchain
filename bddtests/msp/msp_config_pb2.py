...
DESCRIPTOR._options = _descriptor._ParseOptions(descriptor_pb2.FileOptions(), _b('\n!org.hyperledger.mchain.protos.mspB\020MspConfigPackageZ(github.com/hyperledger/mchain/protos/msp'))
try:
