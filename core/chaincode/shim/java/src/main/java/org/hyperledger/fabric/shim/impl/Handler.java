...
package org.hyperledger.mchain.shim.impl;

import static java.lang.String.format;
import static org.hyperledger.mchain.protos.peer.ChaincodeShim.ChaincodeMessage.Type.COMPLETED;
import static org.hyperledger.mchain.protos.peer.ChaincodeShim.ChaincodeMessage.Type.DEL_STATE;
import static org.hyperledger.mchain.protos.peer.ChaincodeShim.ChaincodeMessage.Type.ERROR;
import static org.hyperledger.mchain.protos.peer.ChaincodeShim.ChaincodeMessage.Type.GET_QUERY_RESULT;
import static org.hyperledger.mchain.protos.peer.ChaincodeShim.ChaincodeMessage.Type.GET_STATE;
import static org.hyperledger.mchain.protos.peer.ChaincodeShim.ChaincodeMessage.Type.GET_STATE_BY_RANGE;
import static org.hyperledger.mchain.protos.peer.ChaincodeShim.ChaincodeMessage.Type.INIT;
import static org.hyperledger.mchain.protos.peer.ChaincodeShim.ChaincodeMessage.Type.INVOKE_CHAINCODE;
import static org.hyperledger.mchain.protos.peer.ChaincodeShim.ChaincodeMessage.Type.PUT_STATE;
import static org.hyperledger.mchain.protos.peer.ChaincodeShim.ChaincodeMessage.Type.QUERY_STATE_CLOSE;
import static org.hyperledger.mchain.protos.peer.ChaincodeShim.ChaincodeMessage.Type.QUERY_STATE_NEXT;
import static org.hyperledger.mchain.protos.peer.ChaincodeShim.ChaincodeMessage.Type.READY;
import static org.hyperledger.mchain.protos.peer.ChaincodeShim.ChaincodeMessage.Type.REGISTERED;
import static org.hyperledger.mchain.protos.peer.ChaincodeShim.ChaincodeMessage.Type.RESPONSE;
import static org.hyperledger.mchain.protos.peer.ChaincodeShim.ChaincodeMessage.Type.TRANSACTION;
import static org.hyperledger.mchain.shim.fsm.CallbackType.AFTER_EVENT;
import static org.hyperledger.mchain.shim.fsm.CallbackType.BEFORE_EVENT;
...
import org.hyperledger.mchain.protos.peer.Chaincode.ChaincodeID;
import org.hyperledger.mchain.protos.peer.Chaincode.ChaincodeInput;
import org.hyperledger.mchain.protos.peer.Chaincode.ChaincodeSpec;
import org.hyperledger.mchain.protos.peer.ChaincodeEventPackage.ChaincodeEvent;
import org.hyperledger.mchain.protos.peer.ChaincodeShim.ChaincodeMessage;
import org.hyperledger.mchain.protos.peer.ChaincodeShim.ChaincodeMessage.Type;
import org.hyperledger.mchain.protos.peer.ChaincodeShim.DelState;
import org.hyperledger.mchain.protos.peer.ChaincodeShim.GetQueryResult;
import org.hyperledger.mchain.protos.peer.ChaincodeShim.GetStateByRange;
import org.hyperledger.mchain.protos.peer.ChaincodeShim.GetState;
import org.hyperledger.mchain.protos.peer.ChaincodeShim.PutState;
import org.hyperledger.mchain.protos.peer.ChaincodeShim.QueryResponse;
import org.hyperledger.mchain.protos.peer.ChaincodeShim.QueryStateClose;
import org.hyperledger.mchain.protos.peer.ChaincodeShim.QueryStateNext;
import org.hyperledger.mchain.protos.peer.ProposalResponsePackage.Response;
import org.hyperledger.mchain.protos.peer.ProposalResponsePackage.Response.Builder;
import org.hyperledger.mchain.shim.Chaincode;
import org.hyperledger.mchain.shim.ChaincodeBase;
import org.hyperledger.mchain.shim.ChaincodeStub;
import org.hyperledger.mchain.shim.fsm.CBDesc;
import org.hyperledger.mchain.shim.fsm.Event;
import org.hyperledger.mchain.shim.fsm.EventDesc;
import org.hyperledger.mchain.shim.fsm.FSM;
import org.hyperledger.mchain.shim.fsm.exceptions.CancelledException;
import org.hyperledger.mchain.shim.fsm.exceptions.NoTransitionException;
import org.hyperledger.mchain.shim.helper.Channel;
...
public class Handler {
	...
	// handleMessage message handles loop for org.hyperledger.mchain.shim side
	...
	public synchronized void handleMessage(ChaincodeMessage message) throws Exception {
		...
		if (fsm.eventCannotOccur(message.getType().toString())) {
			String errStr = String.format("[%s]Chaincode handler org.hyperledger.mchain.shim.fsm cannot handle message (%s) with payload size (%d) while in state: %s", message.getTxid(), message.getType(), message.getPayload().size(), fsm.current());
