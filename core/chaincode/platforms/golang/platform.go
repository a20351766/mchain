...
import (
	...
	ccmetadata "github.com/hyperledger/mchain/core/common/ccprovider/metadata"
...
func (goPlatform *Platform) GetDeploymentPayload(spec *pb.ChaincodeSpec) ([]byte, error) {
	...
	var provided = map[string]bool{
		"github.com/hyperledger/mchain/core/chaincode/shim": true,
		"github.com/hyperledger/mchain/protos/peer":         true,
	}
	...
	for _, file := range files {
		...
		// original file.Name:  src/github.com/hyperledger/mchain/examples/chaincode/go/marbles02/META-INF/statedb/couchdb/indexes/indexOwner.json
