...
import (
	...
	"github.com/hyperledger/mchain/core/scc/cscc"
	"github.com/hyperledger/mchain/core/scc/escc"
	"github.com/hyperledger/mchain/core/scc/lscc"
	"github.com/hyperledger/mchain/core/scc/qscc"
	"github.com/hyperledger/mchain/core/scc/vscc"
)
...
var systemChaincodes = []*SystemChaincode{
	{
		Enabled:           true,
		Name:              "cscc",
		Path:              "github.com/hyperledger/mchain/core/scc/cscc",
		InitArgs:          [][]byte{[]byte("")},
	...
	},
	{
		Enabled:           true,
		Name:              "lscc",
		Path:              "github.com/hyperledger/mchain/core/scc/lscc",
		InitArgs:          [][]byte{[]byte("")},
	...
	},
	{
		Enabled:   true,
		Name:      "escc",
		Path:      "github.com/hyperledger/mchain/core/scc/escc",
		InitArgs:  [][]byte{[]byte("")},
	...
	},
	{
		Enabled:   true,
		Name:      "vscc",
		Path:      "github.com/hyperledger/mchain/core/scc/vscc",
		InitArgs:  [][]byte{[]byte("")},
	...
	},
	{
		Enabled:           true,
		Name:              "qscc",
		Path:              "github.com/hyperledger/mchain/core/chaincode/qscc",
		InitArgs:          [][]byte{[]byte("")},
...
//DeploySysCCs is the hook for system chaincodes where system chaincodes are registered with the mchain
