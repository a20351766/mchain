...
func Test_WriteFolderToTarPackage1(t *testing.T) {
	...
	srcPath := filepath.Join(gopath, "src",
		"github.com/hyperledger/mchain/examples/chaincode/java/SimpleSample")
...
func Test_WriteFolderToTarPackage2(t *testing.T) {
	...
	srcPath := filepath.Join(gopath, "src",
		"github.com/hyperledger/mchain/examples/chaincode/java")
	excludeFileTypes := map[string]bool{
		".xml": true,
	}
...
func Test_WriteFolderToTarPackage3(t *testing.T) {
	...
	// since there are no node chaincode examples in mchain repos
	srcPath := filepath.Join(gopath, "src",
		"github.com/hyperledger/mchain/examples/chaincode/go/marbles02")
...
func Test_WriteFolderToTarPackage5(t *testing.T) {
	...
	srcPath := filepath.Join(gopath, "src",
		"github.com/hyperledger/mchain/test/chaincodes/BadMetadataIgnoreHiddenFile")
...
func Test_WriteFolderToTarPackageFailure1(t *testing.T) {
	...
	srcPath := filepath.Join(gopath, "src",
		"github.com/hyperledger/mchain/core/container/util",
...
func Test_WriteFolderToTarPackageFailure2(t *testing.T) {
	...
	// since there are no node chaincode examples in mchain repos
	srcPath := filepath.Join(gopath, "src",
		"github.com/hyperledger/mchain/test/chaincodes/BadMetadataInvalidIndex")
...
func Test_WriteFolderToTarPackageFailure3(t *testing.T) {
	...
	// since there are no node chaincode examples in mchain repos
	srcPath := filepath.Join(gopath, "src",
		"github.com/hyperledger/mchain/test/chaincodes/BadMetadataUnexpectedFolderContent")
