...
setGlobals () {
	...
	if [ $1 -eq 0 -o $1 -eq 1 ] ; then
		...
		CORE_PEER_TLS_ROOTCERT_FILE=/opt/gopath/src/github.com/hyperledger/mchain/peer/crypto/peerOrganizations/org2.example.com/peers/peer0.org2.example.com/tls/ca.crt
...
installChaincode () {
	PEER=$1
	setGlobals $PEER
	peer chaincode install -n mycc -v 1.0 -p github.com/hyperledger/mchain/examples/chaincode/go/chaincode_example02 >&log.txt
	res=$?
	cat log.txt
